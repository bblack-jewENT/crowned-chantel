...
const Charity: React.FC = () => {
      ...
      case "select":
        return (
          <div className="animate-fadeIn">
            <h4 className="text-2xl font-serif font-bold text-white mb-8 text-center">
              Choose Your Impact
            </h4>
            ...
            <div className="mb-8">
              <label className="text-[10px] uppercase tracking-widest text-gray-500 mb-2 block text-center">
            ...
            <div className="bg-black/30 rounded-2xl p-6 border border-white/5 mb-8 min-h-[80px] flex items-center justify-center">
              {selectedTier ? (
                <p className="text-gray-300 text-sm italic text-center animate-slideUp">
                  "
                  {
                    CHARITY_INFO.tiers.find((t) => t.amount === selectedTier)
                      ?.impact
                  }
                  "
                </p>
        ...
        return (
          <div className="animate-fadeIn space-y-6">
            <div className="flex items-center justify-between mb-4">
              <button
                onClick={handleBack}
                className="text-amber-400 text-xs uppercase tracking-widest hover:underline"
              >
            ...
            <p className="text-center text-[9px] text-gray-600 uppercase tracking-widest">
              Your payment is encrypted and secured by CrownPay Gateway
            </p>
          </div>
        );
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-left space-y-3 mb-8">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-white">
                  #QC-{Math.floor(Math.random() * 900000 + 100000)}
                </span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-gray-500 uppercase tracking-widest">
  ...
  return (
    <section
      id="charity"
      className="py-24 px-4 md:px-8 bg-[#0a0a0a] overflow-hidden"
    >
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-xs italic">
                Current goal for the 2026 academic cycle.
              </p>
            </div>
          </div>
