      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        <div className="w-full lg:w-1/2 relative">
          <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border border-white/5 group">
            <img
              src="/WhatsApp%20Image%202026-01-28%20at%2013.53.50.jpeg"
        ...
        <div className="w-full lg:w-1/2 space-y-8">
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              Chantel is more than a model; she is a visionary in the world of
              pageantry and fashion. Beginning her journey on the local runways
              of South Africa, she quickly rose to prominence through her unique
              blend of traditional grace and contemporary high-fashion edge.
            </p>
            <p className="text-gray-400 text-lg leading-relaxed">
              Her recent victory as Miss Dauntless Models Queen 2024 has
              solidified her place as a leader and role model for aspiring
              models across the continent. She advocates for authenticity,
              discipline, and the power of presence.
            </p>
          </div>
